...
namespace Meadow.TinyCLR.Displays.Tft
{
    public abstract class DisplayTftSpiBase : DisplayBase, IDisposable
    {
        ...
        public override void Show()
        {
            ...
            spi.TransferFullDuplex( spiBuffer, 0, len, spiReceive, 0, len);
        ...
        public void Show(uint x0, uint y0, uint x1, uint y1)
        {
            ...
            var len = (int) (x1 - x0 + 1) * sizeof(ushort);
            ...
            {
                sourceIndex = (int)((y * width) + x0) * sizeof(ushort);
                Array.Copy(spiBuffer, sourceIndex, lineBufferSend, 0, len);

                spi.TransferFullDuplex( lineBufferSend,0,len, lineBufferReceive, 0, len);
                //chipSelectPort, ChipSelectMode.ActiveLow,
            }
