...
namespace Meadow.TinyCLR.Sensors.Atmospheric
{
        ...
        IAtmosphericSensor, ITemperatureSensor, IHumiditySensor
    {
        ...
        /// </summary>
        protected readonly I2cDevice si7021;
        ...
        public Si70xx(string i2cBus, byte address = 0x40)
        {
        ...
        {
            si7021.Write(new byte[] { SOFT_RESET });
        ...
        protected AtmosphericConditions ReadSensor()
        {
            ...
            si7021.Write(new byte[] { HUMDITY_MEASURE_NOHOLD });
            //
            ...
            data = new byte[2];
            si7021.WriteRead(new byte[] { TEMPERATURE_MEASURE_PREVIOUS }, data);
        ...
        public void Reset()
        {
            si7021.Write(new byte[] { READ_USER_REGISTER });
            Thread.Sleep(50);
        }
        ...
        public void Heater(bool onOrOff)
        {
            ...
            si7021.WriteRead(new byte[] { READ_USER_REGISTER }, register);
            register[0] &= 0xfd;
            ...
            si7021.Write(new byte[] { WRITE_USER_REGISTER, register[0] });
        }
        ...
        {
            var userData = new byte[1];
            si7021.WriteRead(new byte[] { READ_USER_REGISTER }, userData); //Go get the current register state
            ...
            si7021.Write(new byte[] { WRITE_USER_REGISTER }); //Write to the user register
            si7021.Write(userData); //Write the new resolution bits
        }
