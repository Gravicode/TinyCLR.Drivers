...
namespace Meadow.TinyCLR.Audio.Radio
{
    public class Tea5767
    {
        ...
        public Tea5767(string i2cControllerName, byte address = TEA5767_ADDRESS)
        {
            var settings = new I2cConnectionSettings(address); //The slave's address and the bus speed.
        ...
        void TransmitData()
        {
            i2cPeripheral.Write(transmissionData);
        ...
        {
            //reception_data =
            i2cPeripheral.Read(reception_data);
            Thread.Sleep(100);
        }
