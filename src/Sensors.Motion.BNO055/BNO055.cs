...
namespace Meadow.TinyCLR.Sensors.Motion
{
	...
	public class Bno055
	{
		...
		///     BNO055 object.
		/// </summary>
		private readonly I2cDevice bno055;
	    ...
	    public int Temperature
	    {
	        get {
                var read = new byte[1];
                bno055.WriteRead(new byte[] { Registers.Temperature },read);
                return read[0];
            }
	    }
	    ...
	    public Sensor TemperatureSource
	    {
            ...
            {
                var read = new byte[1];
                bno055.WriteRead(new byte[] { Registers.TemperatureSource }, read);
                return (Sensor)read[0];
                //return bno055.ReadRegister(Registers.TemperatureSource);
            }
	        set
	        {
	            if ((value == Sensor.Accelerometer) || (value == Sensor.Gyroscope))
	            {
	                bno055.Write(new byte[] { Registers.TemperatureSource, (byte)value });
	            }
	            else
	            {
	    ...
	    public byte PowerMode
	    {
            ...
            {
                var read = new byte[1];
                bno055.WriteRead(new byte[] { Registers.PowerMode }, read);
                return read[0];
                //return (bno055.ReadRegister(Registers.PowerMode));
            }
            set
            {
                bno055.Write(new byte[] { Registers.PowerMode, value });
                Thread.Sleep(15);
            }
	    }
	    ...
	    public byte OperatingMode
	    {
            ...
            {
                var read = new byte[1];
                bno055.WriteRead(new byte[] { Registers.OperatingMode }, read);
                return read[0];
	        ...
	        set
	        {
                ...
                bno055.Write(new byte[] { Registers.OperatingMode, value });
                Thread.Sleep(20);
	        }
	    }
	    ...
	    private byte Page
	    {
            ...
            {
                var read = new byte[1];
                bno055.WriteRead(new byte[] { Registers.PageID }, read);
                return read[0];
	        ...
	        set
	        {
	            ...
	            bno055.Write(new byte[] { Registers.PageID, value});
	        }
	    }
	    ...
	    public bool IsSystemCalibrated
	    {
            ...
            {
                var read = new byte[1];
                bno055.WriteRead(new byte[] { Registers.CalibrationStatus }, read);
                return ((read[0] >> 6) & 0x03) != 0;
	    ...
	    public bool IsMagnetometerCalibrated
	    {
	        get {
                var read = new byte[1];
                bno055.WriteRead(new byte[] { Registers.CalibrationStatus }, read);
                return (read[0] & 0x03) != 0;
                //return ((bno055.ReadRegister(Registers.CalibrationStatus) & 0x03) != 0); 
            }
	    }
		...
		public Bno055(string i2cBus, byte address = 0x28)
        {
            ...
            bno055 = controller.GetDevice(settings);
            //bno055 = new I2cPeripheral(i2cBus, address);
            var read = new byte[1];
            bno055.WriteRead(new byte[] { Registers.ChipID }, read);
		...
		public void Read()
        {
            ...
            sensorReadings = new byte[(ushort)(Registers.GravityVectorZMSB - Registers.AccelerometerXLSB)];
            bno055.WriteRead(new byte[] { Registers.AccelerometerXLSB }, sensorReadings);
        ...
        {
            var registers = new byte[0x6a];
            bno055.WriteRead(new byte[] { Registers.ChipID }, registers);
