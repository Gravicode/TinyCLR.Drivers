...
namespace Meadow.TinyCLR.Sensors.Motion
{
        ...
        IAccelerometer
    {
        ...
        /// </summary>
        private readonly I2cDevice adxl345;
        ...
        public sbyte OffsetX {
            get {
                var read = new byte[1];
                adxl345.WriteRead(new byte[] { Registers.OffsetX },read);
                return (sbyte)read[0];
            }
            set { adxl345.Write(new byte[] { Registers.OffsetX, (byte)value }); }
        }
        ...
        public sbyte OffsetY {
            get {
                var read = new byte[1];
                adxl345.WriteRead(new byte[] { Registers.OffsetY }, read);
                return (sbyte)read[0];
                //return (sbyte)adxl345.ReadRegister(Registers.OffsetY); 
            }
            set { adxl345.Write(new byte[] { Registers.OffsetY, (byte)value }); }
        }
        ...
        public sbyte OffsetZ {
            get {
                var read = new byte[1];
                adxl345.WriteRead(new byte[] { Registers.OffsetZ }, read);
                return (sbyte)read[0];
                //return (sbyte)adxl345.ReadRegister(Registers.OffsetZ); 
            }
                set { adxl345.Write(new byte[] { Registers.OffsetZ, (byte)value }); }
        }
        ...
        public Adxl345(string i2cBus, byte address = 0x53)
        {
            ...
            adxl345 = controller.GetDevice(settings);
            //adxl345 = new I2cPeripheral(i2cBus, address);

            var deviceID = new byte[1];
            adxl345.WriteRead(new byte[] { Registers.DeviceID },deviceID);
        ...
        public void SetPowerState(bool linkActivityAndInactivity, bool autoASleep, bool measuring, bool sleep, Frequency frequency)
        {
            ...
            adxl345.Write(new byte[] { Registers.PowerControl, data });
        }
        ...
        public void SetDataFormat(bool selfTest, bool spiMode, bool fullResolution, bool justification, Range range)
        {
            ...
            adxl345.Write(new byte[] { Registers.DataFormat, data });
        }
        ...
        public void SetDataRate(byte dataRate, bool lowPower)
        {
            ...
            adxl345.Write(new byte[] { Registers.DataRate, data });
        }
        ...
        {
            var data = new byte[6];
            adxl345.WriteRead(new byte[] { Registers.X0 }, data);
