...
namespace Meadow.TinyCLR.Displays.Lcd
{
    ...
    {
        protected I2cDevice i2cPeripheral;
        ...
        public I2cCharacterDisplay(string i2cBus, byte address = DefaultI2cAddress, byte rows = 4, byte columns = 20)
        {
        ...
        {
            i2cPeripheral.Write(new byte[] { (byte)(value | backlightValue) });
        }
        ...
        {
            SetCursorPosition(0, lineNumber);
            var screenText = GpioCharacterDisplay.padRight(text, DisplayConfig.Width, " ");
            Write(screenText);
        }
        ...
        public void DisplayOff()
        {
            ...
            Command((byte)(LCD_DISPLAYCONTROL | displayControl));
        }
        ...
        public void SaveCustomCharacter(byte[] characterMap, byte address)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                i2cPeripheral.Write(new byte[] { Rs, characterMap[i] });
            }
        }
