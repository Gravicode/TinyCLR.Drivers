...
using Meadow.TinyCLR.Displays.TextDisplayMenu.InputTypes;
...
namespace Meadow.TinyCLR.Displays.TextDisplayMenu
{
    public class Menu
    {
        const string INPUT_TYPES_NAMESPACE = "Meadow.TinyCLR.Displays.TextDisplayMenu.InputTypes.";
        ...
        {
            var menuJson = Encoding.UTF8.GetString(menuResource);
            var menuData = Json.NETMF.JsonSerializer.DeserializeString(menuJson) as Hashtable; //from nuget package
