...
namespace Meadow.TinyCLR.RTCs
{
    public class Ds323x
    {
        ...
        /// </summary>
        protected I2cDevice _ds323x = null;

        /// <summary>
        ///     Interrupt port attached to the DS323x RTC module.
        /// </summary>
        protected GpioPin _interruptPort;
        ...
        public DateTime CurrentDateTime
        {
            get
            {
                var data = new byte[DATE_TIME_REGISTERS_SIZE];
                 _ds323x.WriteRead(new byte[] { Registers.Seconds },data );
                return DecodeDateTimeRegisters(data);
            }
            set {
                var bytes = EncodeDateTimeRegisters(value);
                var datas = new byte[bytes.Length+1];
                datas[0] = Registers.Seconds;
        ...
        public double Temperature
        {
            ...
            {
                var data = new byte[2];
                _ds323x.WriteRead(new byte[] { Registers.TemperatureMSB }, data);
        ...
        protected byte ControlRegister
        {
            get {
                var data = new byte[1];
                _ds323x.WriteRead(new byte[] { Registers.Control }, data);
                return data[0];
            }
            set { _ds323x.Write(new byte[] { Registers.Control, value }); }
        }
        ...
        protected byte ControlStatusRegister
        {
            get {
                ...
                var data = new byte[1];
                _ds323x.WriteRead(new byte[] { Registers.ControlStatus }, data);
                return data[0];

               }
            set {
                _ds323x.Write(new byte[] { Registers.ControlStatus, value });
                }
        }
        ...
        protected void _interruptPort_ValueChanged(GpioPin sender, GpioPinValueChangedEventArgs e)
        {
