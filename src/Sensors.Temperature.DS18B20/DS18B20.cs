...
namespace Sensors.Temperature.DS18B20
{
    public class DS18B20 : ITemperatureSensor
    {
        ...
        public float Temperature
        {
            ...
            private set
            {
                ...
                {
                    Updated?.Invoke(this, new AtmosphericConditionChangeResult(new AtmosphericConditions(_lastNotifiedTemperature,0,0),null));
