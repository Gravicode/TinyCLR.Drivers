        ...
        IAccelerometer
    {
        ...
        public bool DataReady {
            get {
                ...
                _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.DeviceID }, status);
        ...
        public int DeviceID {
            get {
                ...
                _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.DeviceID }, deviceID);
        ...
        public byte Status {
            get {
                ...
                _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.Status }, result);
                return result[0];
            }
        }
        ...
        public double Temperature {
            get {
                ...
                _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.TemperatureLSB }, result);
        ...
        public byte ActivityInactivityControl {
            get {
                ...
                _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.ActivityInactivityControl }, registers);
                return (registers[0]);
            }
            set {
                _adxl362.Write(new byte[] { Command.WriteRegister, value });
            }
        }
        ...
        public bool SelfTest {
            set {
                ...
                _adxl362.Write(new byte[] { Command.WriteRegister, selfTest });
            }
        }
        ...
        public byte FilterControl {
            get {
                ...
                _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.FilterControl }, register);
                return (register[0]);
            }
            set {
                _adxl362.Write(new byte[] { Command.WriteRegister, value });
        ...
        public void Reset()
        {
            _adxl362.Write(new byte[] { Command.WriteRegister, Registers.SoftReset, 0x52 });
            Thread.Sleep(10);
        }
        ...
        public void Start()
        {
            _adxl362.Write(new byte[] { Command.WriteRegister, Registers.PowerControl, 0x02 });
        }
        ...
        public void Stop()
        {
            var powerControl = new byte[1];
            _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.PowerControl, 0x02 }, powerControl);
            byte power = (byte)((powerControl[0] & (~PowerControlMask.Measure)) & 0xff);
            _adxl362.Write(new byte[] { Command.WriteRegister, Registers.PowerControl, power });
        }
        ...
        public void Update()
        {
            var sensorReading = new byte[8];
            _adxl362.TransferFullDuplex(new byte[] { Command.Readegister, Registers.XAxisLSB }, sensorReading);
        ...
        private GpioPinEdge MapInterruptMode(bool activeLow)
        {
            if (activeLow) {
        ...
        private void ConfigureInterrupts( byte interruptMap1, int interruptPin1, byte interruptMap2 = 0, int interruptPin2 = -1) // TODO: interrupPin2 = IDigitalPin.GPIO_NONE
        {
            _adxl362.Write(new byte[] { Command.WriteRegister, interruptMap1, interruptMap2 });
            var gpio = GpioController.GetDefault();

          
            if (interruptPin1 != -1) {
                _digitalInputPort1 = gpio.OpenPin(interruptPin1);
                var res = MapResistorMode((interruptMap1 & 0xf0) > 0);
                _digitalInputPort1.SetDriveMode(res== ResistorMode.PullUp ? GpioPinDriveMode.InputPullUp: GpioPinDriveMode.InputPullDown);
                _digitalInputPort1.ValueChanged += InterruptChanged; 
            ...
            if (interruptPin2 != -1) {
                _digitalInputPort2 = gpio.OpenPin(interruptPin2);
                var res = MapResistorMode((interruptMap2 & 0xf0) > 0);
                _digitalInputPort2.SetDriveMode(res == ResistorMode.PullUp ? GpioPinDriveMode.InputPullUp : GpioPinDriveMode.InputPullDown);
                _digitalInputPort2.ValueChanged += InterruptChanged;
        ...
        private void InterruptChanged(GpioPin sender, GpioPinValueChangedEventArgs e)
        {
            var status = Status;
