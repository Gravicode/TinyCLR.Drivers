...
namespace Meadow.TinyCLR.Sensors.Atmospheric
{
    ...
    /// </summary>
    public class Bmp180 : IAtmosphericSensor, IBarometricPressureSensor, ITemperatureSensor
    {
        ...
        /// </summary>
        private readonly I2cDevice bmp180;
        ...
        /// </summary>
        public Bmp180(string i2cBus, byte address = 0x77, DeviceMode deviceMode = DeviceMode.Standard)
        {
            ...
            bmp180 = controller.GetDevice(settings);
        ...
        private long ReadUncompensatedTemperature()
        {
            ...
            bmp180.Write(new byte[] { 0xF4, 0x2E });

            // Required as per datasheet.
            Thread.Sleep(5);

            // write register address
            bmp180.Write(new byte[] { 0xF6 });
        ...
        {
            // write register address
            bmp180.Write(new byte[] { 0xF4, (byte)(0x34 + (oversamplingSetting << 6)) });
            ...
            bmp180.WriteRead(new byte[] { 0xF6 }, data);
        ...
        private short ReadShort(byte address)
        {
            // get MSB and LSB result
            byte[] data = new byte[2];
            bmp180.WriteRead(new byte[] { address }, data);
