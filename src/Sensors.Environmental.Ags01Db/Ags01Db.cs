...
namespace Meadow.TinyCLR.Sensors.Environmental
{
    ...
    public class Ags01Db
    {
        ...
        private readonly I2cDevice sensor;
        ...
        public double GetConcentration()
        {
            ...
            ushort res = BitConverter.ToUInt16(readBuffer, 0); //BinaryPrimitives.ReadUInt16BigEndian(readBuffer.AsSpan(0, 2));
