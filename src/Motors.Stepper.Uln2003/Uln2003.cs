...
namespace Meadow.TinyCLR.Motors.Stepper
{
    ...
    public class Uln2003
    {
        ...
        private readonly GpioPin outputPort1;
        private readonly GpioPin outputPort2;
        private readonly GpioPin outputPort3;
        private readonly GpioPin outputPort4;
        ...
        public Uln2003( int pin1, int pin2, int pin3, int pin4)
        {
            ...
            outputPort1 = gpio.OpenPin(pin1);
            outputPort1.SetDriveMode(GpioPinDriveMode.Output);

            outputPort2 = gpio.OpenPin(pin2);
            outputPort2.SetDriveMode(GpioPinDriveMode.Output);

            outputPort3 = gpio.OpenPin(pin3);
            outputPort3.SetDriveMode(GpioPinDriveMode.Output);

            outputPort4 = gpio.OpenPin(pin4);
            outputPort4.SetDriveMode(GpioPinDriveMode.Output);
        ...
        public void Stop()
        {
            ...
            outputPort1.Write(GpioPinValue.Low);// false;
            outputPort2.Write(GpioPinValue.Low);// false;
            outputPort3.Write(GpioPinValue.Low);// false;
            outputPort4.Write(GpioPinValue.Low);// false;
        }
        ...
        {
            outputPort1.Write(currentSwitchingSequence[0, engineStep - 1] ? GpioPinValue.High : GpioPinValue.Low);
            outputPort2.Write(currentSwitchingSequence[1, engineStep - 1] ? GpioPinValue.High : GpioPinValue.Low);
            outputPort3.Write(currentSwitchingSequence[2, engineStep - 1] ? GpioPinValue.High : GpioPinValue.Low);
            outputPort4.Write(currentSwitchingSequence[3, engineStep - 1] ? GpioPinValue.High : GpioPinValue.Low);
        }
