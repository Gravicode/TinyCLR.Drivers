...
namespace Meadow.Foundation.Sensors.Temperature
{
        ...
        IAtmosphericSensor, ITemperatureSensor
    {
        ...
        ///     LM75 sensor.
        /// </summary>
        private readonly I2cDevice lm75;
        ...
        public Lm75(string i2cBus, byte address = 0x48)
        {
            ...
            lm75 = controller.GetDevice(settings);
        ...
        public void Update()
        {
            lm75.Write(new byte[] { (byte)Register.LM_TEMP });

            var data = new byte[2];
            lm75.WriteRead(new byte[] { (byte)Register.LM_TEMP }, data);
            //return read[0];
            ...
            Conditions.Temperature = (float)Math.Round(temp);
        }
