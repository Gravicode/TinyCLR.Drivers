...
namespace Meadow.Foundation.Sensors.Atmospheric
{
        ...
        IAtmosphericSensor, ITemperatureSensor, IBarometricPressureSensor
    {
        ...
        /// </summary>
        private readonly I2cDevice mpl115a2;
        ...
        public Mpl115a2(string i2cBus, byte address = 0x60)
        {
            ...
            mpl115a2 = controller.GetDevice(settings);
            ...
            //
            var data = new byte[8];
            mpl115a2.WriteRead(new byte[] { Registers.A0MSB }, data);
        ...
        public void Update()
        {
            ...
            //
            mpl115a2.Write(new byte[] { Registers.StartConversion, 0x00 });

            Thread.Sleep(5);

            var data = new byte[4];
            mpl115a2.WriteRead(new byte[] { Registers.PressureMSB }, data);
            //
