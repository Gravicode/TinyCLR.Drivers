...
namespace Meadow.TinyCLR.Leds
{
    ...
    public class Apa102
    {
        //ToDo this could probably move into Meadow.TinyCLR.Core
        ...
        protected SpiDevice spiPeripheral;
        ...
        public Apa102(string spiBus, GpioPin chipSelect, uint numberOfLeds, PixelOrder pixelOrder = PixelOrder.BGR, bool autoWrite = false)
        {
            ...
            spiPeripheral = controller.GetDevice(settings);
