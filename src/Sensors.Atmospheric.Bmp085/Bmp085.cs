...
namespace Meadow.TinyCLR.Sensors.Atmospheric
{
    ...
    /// </summary>
    public class Bmp085 : IAtmosphericSensor, IBarometricPressureSensor, ITemperatureSensor
    {
        ...
        /// </summary>
        private readonly I2cDevice bmp085;
        ...
        /// </summary>
        public Bmp085(string i2cBus, byte address = 0x77, DeviceMode deviceMode = DeviceMode.Standard)
        {
            ...
            bmp085 = controller.GetDevice(settings);
        ...
        private long ReadUncompensatedTemperature()
        {
            ...
            bmp085.Write(new byte[] { 0xF4, 0x2E });

            // Required as per datasheet.
            Thread.Sleep(5);

            // write register address
            bmp085.Write(new byte[] { 0xF6 });
        ...
        {
            // write register address
            bmp085.Write(new byte[] { 0xF4, (byte)(0x34 + (oversamplingSetting << 6)) });
            ...
            bmp085.WriteRead(new byte[] { 0xF6 },data);
        ...
        private short ReadShort(byte address)
        {
            // get MSB and LSB result
            byte[] data = new byte[2];
            bmp085.WriteRead(new byte[] { address }, data);
