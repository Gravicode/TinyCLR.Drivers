...
namespace Meadow.TinyCLR.Displays.ePaper
{
    ...
    {
        public Il91874V03( string SpiControllerName, int chipSelectPin, int dcPin, int resetPin, int busyPin,
            uint width = 176, uint height = 264) :
            base( SpiControllerName, chipSelectPin, dcPin, resetPin, busyPin, width, height)
        { }
