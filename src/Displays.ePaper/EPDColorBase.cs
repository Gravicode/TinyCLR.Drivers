...
namespace Meadow.TinyCLR.Displays.ePaper
{
    /// <summary>
    ...
    public abstract class EpdColorBase : SpiDisplayBase
    {
        ...
        public EpdColorBase(string SpiControllerName, int chipSelectPin, int dcPin, int resetPin, int busyPin,
            uint width, uint height)
        {
            ...
            busyPort = gpio.OpenPin(busyPin);
            busyPort.SetDriveMode(GpioPinDriveMode.Input);
