...
using static Meadow.TinyCLR.Sensors.Atmospheric.Bme280;
...
namespace Meadow.TinyCLR.Sensors.Atmospheric
{
                 ...
                 IAtmosphericSensor, ITemperatureSensor, IHumiditySensor, IBarometricPressureSensor
    {
        ...
        public Bme280(string spiBus, GpioPin chipSelect)
        {
            ...
            var spi = controller.GetDevice(settings);
        ...
        void UpdateTemp()
        {
            var oldConditions = UpdateData.oldConditions;
            ...
            while (true)
            {
                ...
                // read
                Read(UpdateData.temperatureSampleCount, UpdateData.pressureSampleCount, UpdateData.humiditySampleCount);

                // build a new result with the old and new conditions
                UpdateData.result = new AtmosphericConditionChangeResult(oldConditions, Conditions);

                // let everyone know
                RaiseChangedAndNotify(UpdateData.result);
        ...
        /// </remarks>
        protected AtmosphericConditions Read()
        {
        ...
        {
            return _bme280.ReadRegisters((byte)Bme280Comms.Register.ChipID, 1)[0];
        }
    ...
    public class TempUpdateData
    {
        ...
        public Oversample temperatureSampleCount = Oversample.OversampleX8;
        public Oversample pressureSampleCount = Oversample.OversampleX8;
        public Oversample humiditySampleCount = Oversample.OversampleX1;
