...
namespace Meadow.TinyCLR.Sensors.LoadCell
{
    ...
    public class Nau7802 : IDisposable //Todo: FilterableObservableBase<FloatChangeResult, float>,  IDisposable
    {
        ...
        private float gramsPerAdcUnit = 0;
        ...
        private byte ReadRegister(Register register)
        {
            lock (SyncRoot)
            {
                ...
                Device.WriteRead( new byte []{ Address, write[0] }, read);
        ...
        private void PowerOn()
        {
            ...
            Debug.WriteLine($"PU_CTRL: 0x{currentPU_CTRL:x}");
        ...
        private int DoConversion()
        {
            ...
            */
            ...
            {
                Debug.WriteLine("ADC is busy");
                return 0;
            }

            //read
            Debug.WriteLine("Reading ADC...");
            var adc = ReadADC();
            Debug.WriteLine($"ADC = 0x{adc:x}");
