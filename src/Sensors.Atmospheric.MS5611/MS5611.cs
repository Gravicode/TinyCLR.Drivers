...
namespace Meadow.TinyCLR.Sensors.Atmospheric
{
    public class Ms5611
    {
        ...
        public Ms5611(I2cDevice i2c, byte address = 0x76, Resolution resolution = Resolution.OSR_1024)
        {
            switch (address)
            {
                case 0x76:
        ...
        /// <param name="resolution"></param>
        public Ms5611(SpiDevice spi, int chipSelect, Resolution resolution = Resolution.OSR_1024)
        {
