    ...
    public class Ds1307
    {
        ...
        public bool IsRunning
        {
            get
            {
                ...
                var reg = new byte[0x01];
                _bus.WriteRead(new byte[] { Address,0x00 }, reg);
                return (reg[0] & (1 << 7)) != 0;
            }
            set
            {
                ...
                _bus.Write(new byte[] { Address, 0x00, reg[0] });
            }
        }
        ...
        public DateTime GetTime()
        {
            ...
            _bus.WriteRead( new byte[] { Address, 0x00 },data);
        ...
        public void SetTime(DateTime time)
        {
            ...
            var bytes = ToRTCTime(time);
            var datas = new byte[2 + bytes.Length];
            datas[0] = Address;
            datas[1] = 0; // target start register offset
        ...
        public byte[] ReadRAM(int offset, int count)
        {
            ...
            _bus.WriteRead(new byte[] { Address, (byte)(0x08 + offset) }, data);
            return data;
        }
        ...
        public void WriteRAM(int offset, params byte[] data)
        {
            ...
            var datas = d.ToArray(typeof(byte)) as byte[];
            _bus.Write(datas);
        }
